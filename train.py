...
def train(args):
    ...
    d_optimizer = tf.train.AdamOptimizer(learning_rate = args.d_learning_rate).minimize(D_loss, var_list=theta_D)
   ...
   # g_optimizer = tf.train.AdamOptimizer(learning_rate = args.learning_rate)\
    ...
    g_optimizer = tf.train.AdamOptimizer(learning_rate = args.g_learning_rate).minimize(G_loss, var_list=theta_G)
